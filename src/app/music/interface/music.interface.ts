// To parse this data:
//
//   import { Convert, DeezerSearch } from "./file";
//
//   const deezerSearch = Convert.toDeezerSearch(json);
//
...
export class Convert {
  public static toDeezerSearch(json: string): DeezerSearch {
    return cast(JSON.parse(json), r("DeezerSearch"));
  }

  public static deezerSearchToJson(value: DeezerSearch): string {
    return JSON.stringify(uncast(value, r("DeezerSearch")), null, 2);
  }
}
...
const typeMap: any = {
  ...
  "Datum": o([
    ...
    { json: "title_version", js: "title_version", typ: u(undefined, r("TitleVersion")) },
  ], false),
  "Album": o([
    { json: "id", js: "id", typ: 0 },
    { json: "title", js: "title", typ: "" },
